  ...
  ctx: {
    ...
    children: {
      ...{
        ...
        settings: {
          description: 'Widget settings containing widget specific properties according to the defined <a href="https://docs.yiqisoft.cn/YiCONNECT/administration-ui/widgets/">settings json schema</a>',
          meta: 'property',
          type: 'object'
        },
        datasources: {
